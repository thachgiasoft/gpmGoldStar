...
namespace BanHang
{
    public partial class BangKeBanVe : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                dtLichSuHeThong.ThemLichSuTruyCap(IDNhanVien, "Bảng kê bán vé", "Truy cập bảng kê");
            }
        }
        ...
        protected void btnXemBaoCao_Click(object sender, EventArgs e)
        {
            ...
            popup.ContentUrl = "~/InBangKeBanVe.aspx?ngayBD=" + ngayBD + "&ngayKT=" + ngayKT;
