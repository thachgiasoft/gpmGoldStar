...
namespace BanHang
{
    public partial class BangKeNhapHang : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                dtLichSuHeThong.ThemLichSuTruyCap(IDNhanVien, "Bảng kê nhập hàng", "Truy cập bảng kê");
            }
        }
        ...
        protected void btnXemBaoCao_Click(object sender, EventArgs e)
        {
            ...
            popup.ContentUrl = "~/InBangKeNhapHang.aspx?ngayBD=" + ngayBD + "&ngayKT=" + ngayKT;
