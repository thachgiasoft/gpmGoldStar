    ...
    public partial class BangKePhieuXuatKhac : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                dtLichSuHeThong.ThemLichSuTruyCap(IDNhanVien, "Bảng kê phiếu xuất khác", "Truy cập bảng kê");
            }
        }
        ...
        protected void btnXemBaoCao_Click(object sender, EventArgs e)
        {
            ...
            popup.ContentUrl = "~/InBangKePhieuXuatKhac.aspx?ngayBD=" + ngayBD + "&ngayKT=" + ngayKT;
