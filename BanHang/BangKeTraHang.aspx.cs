...
namespace BanHang
{
    public partial class BangKeTraHang : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                dtLichSuHeThong.ThemLichSuTruyCap(IDNhanVien, "Bảng kê trả hàng", "Truy cập bảng kê");
            }
        }
        ...
        protected void btnXemBaoCao_Click(object sender, EventArgs e)
        {
            ...
            popup.ContentUrl = "~/InBangKeTraHang.aspx?ngayBD=" + ngayBD + "&ngayKT=" + ngayKT;
