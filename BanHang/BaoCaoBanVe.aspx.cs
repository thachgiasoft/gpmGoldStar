...
namespace BanHang
{
    public partial class BaoCaoBanVe : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                dtLichSuHeThong.ThemLichSuTruyCap(IDNhanVien, "Báo cáo bán vé", "Truy cập báo cáo");
            }
        }
        ...
        protected void btnXemBaoCao_Click(object sender, EventArgs e)
        {
            ...
            popup.ContentUrl = "~/InBaoCaoBanVe.aspx?ngayBD=" + ngayBD + "&ngayKT=" + ngayKT;
