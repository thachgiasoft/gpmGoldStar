<%@ Page Title="" Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeBehind="BaoCaoKiemKho.aspx.cs" Inherits="BanHang.BaoCaoKiemKho" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" Width="100%">
        <Items>
            <dx:LayoutGroup Caption="Thông tin kiểm kho" ColCount="4" HorizontalAlign="Center">
                <Items>
    ...
    <dx:ASPxPopupControl ID="popup" runat="server" AllowDragging="True" AllowResize="True" 
         ...
         Height="550px" FooterText="Thông tin kiểm kho"
