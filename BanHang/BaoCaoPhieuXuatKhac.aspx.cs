...
namespace BanHang
{
    public partial class BaoCaoPhieuXuatKhac : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                dtLichSuHeThong.ThemLichSuTruyCap(IDNhanVien, "Báo cáo phiếu xuất khác", "Truy cập báo cáo");
            }
        }
        ...
        protected void btnXemBaoCao_Click(object sender, EventArgs e)
        {
            ...
            popup.ContentUrl = "~/InBaoCaoPhieuXuatKhac.aspx?ngayBD=" + ngayBD + "&ngayKT=" + ngayKT;
