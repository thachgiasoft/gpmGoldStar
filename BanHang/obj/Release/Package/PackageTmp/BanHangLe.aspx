                            ...
                            <tr>
                                <td width="80%">
                                    ...
                                    <asp:SqlDataSource ID="dsHangHoa" runat="server" 
                                        ...
                                        SelectCommand="SELECT GPM_HangHoa.ID,GPM_HangHoa.MaHang, GPM_HangHoa.TenHangHoa,GPM_HangHoaTonKho.GiaBan, GPM_DonViTinh.TenDonViTinh, GPM_HangHoa.GiaBan1 FROM GPM_DonViTinh INNER JOIN GPM_HangHoa ON GPM_DonViTinh.ID = GPM_HangHoa.IDDonViTinh INNER JOIN GPM_HangHoaTonKho ON GPM_HangHoaTonKho.IDHangHoa = GPM_HangHoa.ID WHERE (GPM_HangHoaTonKho.IDKho = @IDKho) AND (GPM_HangHoaTonKho.DaXoa = 0)">
                                        <SelectParameters>
                                            <asp:SessionParameter Name="IDKho" SessionField="IDKho" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                                </td>
                                <td>
                ...
                <dx:ASPxPanel ID="PanelGridHangHoa" ClientInstanceName="PanelGridHangHoa"  runat="server" Width="96%" DefaultButton="btnUpdateGridHang">
                    ...
                    <dx:ASPxGridView runat="server" Width="100%" ID="gridChiTietHoaDon" 
                        ...
                        <columns>
                            ...
                            <dx:GridViewDataTextColumn Caption="Mã hàng"  FieldName="MaHang" VisibleIndex="1" AdaptivePriority="1" Width="120px">                                    
                            </dx:GridViewDataTextColumn>
                                    ...
                                    <dx:ContentControl runat="server">
                                        <dx:ASPxGridView ID="ASPxGridViewInBuil" runat="server" AccessibilityCompliant="True" AutoGenerateColumns="False" KeyFieldName="ID">
                                            ...
                                            <Columns>
                                                ...
                                                <dx:GridViewDataTextColumn Caption="Tổng tiền" FieldName="TongTien" ShowInCustomizationForm="True" VisibleIndex="4">
                                                </dx:GridViewDataTextColumn>
                                            </Columns>
                                        </dx:ASPxGridView>
                                    </dx:ContentControl>
