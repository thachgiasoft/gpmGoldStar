<%@ Page Title="" Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeBehind="BangKePhieuNhapLe.aspx.cs" Inherits="BanHang.BangKePhieuNhapLe" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    ...
    <%--popup chi tiet don hang--%>
     <dx:ASPxPopupControl ID="popup" runat="server" AllowDragging="True" AllowResize="True" 
         ...
         Height="550px" FooterText="Thông tin thống kê"
        HeaderText="Thống kê nhập hàng lẻ" ClientInstanceName="popup" EnableHierarchyRecreation="True">
    </dx:ASPxPopupControl>
</asp:Content>
