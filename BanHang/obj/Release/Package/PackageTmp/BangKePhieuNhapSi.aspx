<%@ Page Title="" Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeBehind="BangKePhieuNhapSi.aspx.cs" Inherits="BanHang.BangKePhieuNhapSi" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    ...
    <%--popup chi tiet don hang--%>
     <dx:ASPxPopupControl ID="popup" runat="server" AllowDragging="True" AllowResize="True" 
        ...
        HeaderText="Thông tin nhập hàng sỉ" ClientInstanceName="popup" EnableHierarchyRecreation="True">
    </dx:ASPxPopupControl>
</asp:Content>
