<%@ Page Title="" Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeBehind="BangKePhieuXuatTra.aspx.cs" Inherits="BanHang.BangKePhieuXuatTra" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
        ...
        <Items>
            <dx:LayoutGroup Caption="Thời gian báo cáo" ColCount="2" HorizontalAlign="Center">
                <Items>
                    ...
                    <dx:LayoutItem Caption="Nhà cung cấp" Name="cmbNhaCungCap">
                        <LayoutItemNestedControlCollection>
    ...
    <%--popup chi tiet don hang--%>
     <dx:ASPxPopupControl ID="popup" runat="server" AllowDragging="True" AllowResize="True" 
        ...
        HeaderText="Thông tin phiếu xuất trả" ClientInstanceName="popup" EnableHierarchyRecreation="True">
    </dx:ASPxPopupControl>
</asp:Content>
