<%@ Page Title="" Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeBehind="BaoCaoBanHangLe.aspx.cs" Inherits="BanHang.BaoCaoBanHangLe" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" Width="100%">
        <Items>
            <dx:LayoutGroup Caption="Thời gian báo cáo" ColCount="3" HorizontalAlign="Center">
                <Items>
