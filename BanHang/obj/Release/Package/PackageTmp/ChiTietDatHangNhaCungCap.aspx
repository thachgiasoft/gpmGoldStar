<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChiTietDatHangNhaCungCap.aspx.cs" Inherits="BanHang.ChiTietDatHangNhaCungCap" %>
...
<body>
    ...
    <div>
        <dx:ASPxGridView runat="server" AutoGenerateColumns="False" Width="100%" ID="gridChiTietDonHang" KeyFieldName="ID" OnRowUpdating="gridChiTietDonHang_RowUpdating">
...
<Columns>
    <dx:GridViewCommandColumn VisibleIndex="8" ShowEditButton="True" ShowClearFilterButton="True">
