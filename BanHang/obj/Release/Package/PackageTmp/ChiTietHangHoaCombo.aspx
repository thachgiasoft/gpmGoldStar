...
<body>
    ...
    <div>
            <dx:ASPxGridView runat="server" AutoGenerateColumns="False" Width="100%" ID="gridChiTietHangHoaCombo" KeyFieldName="ID" OnRowDeleting="gridChiTietPhieuNhapSi_RowDeleting" OnRowUpdating="gridChiTietPhieuNhapSi_RowUpdating">
...
<SettingsText Title="Thông tin chi tiết hàng hóa combo" CommandDelete="Xóa" ConfirmDelete="Bạn chắc chắn muốn xóa?" CommandEdit="Sửa"></SettingsText>
...
<Columns>
    <dx:GridViewCommandColumn VisibleIndex="8" ShowEditButton="True" ShowDeleteButton="True">
