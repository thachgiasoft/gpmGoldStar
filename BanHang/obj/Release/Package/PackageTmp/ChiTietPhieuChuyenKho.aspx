...
<body>
    ...
    <div>
     <dx:ASPxGridView runat="server" AutoGenerateColumns="False" Width="100%" ID="gridChiTietPhieuChuyenKho" KeyFieldName="ID" OnRowUpdating="gridChiTietPhieuChuyenKho_RowUpdating" OnRowDeleting="gridChiTietPhieuChuyenKho_RowDeleting">
...
<SettingsText Title="Thông tin chi tiết phiếu chuyển kho" CommandDelete="Xóa" ConfirmDelete="Bạn chắc chắn muốn xóa?" CommandEdit="Sửa"></SettingsText>
