<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChiTietPhieuNhapLe.aspx.cs" Inherits="BanHang.ChiTietPhieuNhapLe" %>
...
<body>
    ...
    <div>
         <dx:ASPxGridView runat="server" AutoGenerateColumns="False" Width="100%" ID="gridChiTietPhieuNhapLe" KeyFieldName="ID" OnRowDeleting="gridChiTietPhieuNhapLe_RowDeleting" OnRowUpdating="gridChiTietPhieuNhapLe_RowUpdating">
...
<SettingsText Title="Thông tin chi tiết phiếu nhập sỉ" CommandDelete="Xóa" ConfirmDelete="Bạn chắc chắn muốn xóa?" CommandEdit="Sửa"></SettingsText>
        <EditFormLayoutProperties ColCount="2">
            <Items>
                ...
                <dx:GridViewColumnLayoutItem Caption="Đơn Vị Tính" ColumnName="ĐVT">
                </dx:GridViewColumnLayoutItem>
                <dx:GridViewColumnLayoutItem Caption="Số Lượng" ColumnName="Số Lượng" Name="SoLuong">
                </dx:GridViewColumnLayoutItem>
                <dx:GridViewColumnLayoutItem ColumnName="Giá Nhập">
                </dx:GridViewColumnLayoutItem>
...
<Columns>
    ...
    <dx:GridViewDataSpinEditColumn Caption="Giá Nhập" FieldName="GiaNhap" VisibleIndex="4">
        <propertiesspinedit DisplayFormatString="N0"></propertiesspinedit>
    </dx:GridViewDataSpinEditColumn>
    ...
    <dx:GridViewDataComboBoxColumn FieldName="IDDonViTinh" Caption="ĐVT" VisibleIndex="1" ReadOnly="True">
