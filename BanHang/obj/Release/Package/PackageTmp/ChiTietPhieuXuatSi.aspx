<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChiTietPhieuXuatSi.aspx.cs" Inherits="BanHang.ChiTietPhieuXuatSi" %>
...
<body>
    ...
    <div>
     <dx:ASPxGridView runat="server" AutoGenerateColumns="False" Width="100%" ID="gridChiTietPhieuXuatSi" KeyFieldName="ID" OnRowUpdating="gridChiTietPhieuXuatSi_RowUpdating">
...
<SettingsText Title="Thông tin chi tiết phiếu xuất sỉ" CommandDelete="Xóa" ConfirmDelete="Bạn chắc chắn muốn xóa?" CommandEdit="Sửa"></SettingsText>
        <EditFormLayoutProperties ColCount="2">
            <Items>
                <dx:GridViewColumnLayoutItem Caption="Hàng Hóa" ColumnName="Hàng Hóa" Name="IDHangHoa" ColSpan="2">
                </dx:GridViewColumnLayoutItem>
                <dx:GridViewColumnLayoutItem Caption="Số Lượng" ColumnName="Số Lượng" Name="SoLuong">
                </dx:GridViewColumnLayoutItem>
                <dx:GridViewColumnLayoutItem ColumnName="Đơn Giá" RequiredMarkDisplayMode="Required">
                </dx:GridViewColumnLayoutItem>
