...
<body>
    ...
    <div>
             <dx:ASPxGridView runat="server" AutoGenerateColumns="False" Width="100%" ID="gridChiTietPhieuXuatTra" KeyFieldName="ID" OnRowUpdating="gridChiTietPhieuXuatTra_RowUpdating">
...
<SettingsText Title="Thông tin chi tiết phiếu xuất trả" CommandDelete="Xóa" ConfirmDelete="Bạn chắc chắn muốn xóa?" CommandEdit="Sửa"></SettingsText>
