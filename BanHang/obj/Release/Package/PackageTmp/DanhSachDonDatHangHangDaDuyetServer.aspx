<%@ Page Title="" Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeBehind="DanhSachDonDatHangHangDaDuyetServer.aspx.cs" Inherits="BanHang.DanhSachDonDatHangHangDaDuyetServer" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
            ...
            <dx:LayoutItem Caption="">
                <LayoutItemNestedControlCollection>
                    <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer3" runat="server">
                        <dx:ASPxButton ID="btnDanhSachDonHangChoDuyet" runat="server" HorizontalAlign="Right" PostBackUrl="DuyetHangServer.aspx" Text="Danh sách đơn hàng chờ duyệt" VerticalAlign="Middle">
    ...
    <dx:ASPxGridView ID="gridDanhSachDonHang" runat="server" AutoGenerateColumns="False" Width="100%" KeyFieldName="ID">
        ...
        <SettingsText CommandDelete="Xóa" CommandNew="Thêm" Title="DANH SÁCH ĐƠN HÀNG  ĐÃ DUYỆT Ở CHI NHÁNH" PopupEditFormCaption="Thông tin đơn hàng"/>
        <Columns>
            ...
            <dx:GridViewDataDateColumn Caption="Ngày Duyệt Hàng" VisibleIndex="5" FieldName="NgayCapNhat">
                <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy">
                </PropertiesDateEdit>
            </dx:GridViewDataDateColumn>
            ...
            <dx:GridViewDataComboBoxColumn Caption="Chi Nhánh" VisibleIndex="0" FieldName="IDKho">
