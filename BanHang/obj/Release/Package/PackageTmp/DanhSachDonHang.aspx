<%@ Page Title="" Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeBehind="DanhSachDonHang.aspx.cs" Inherits="BanHang.DanhSachDonHang" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    ...
    <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server" ColCount="3">
        <Items>
            ...
            <dx:LayoutItem Caption="">
                <LayoutItemNestedControlCollection>
                    <dx:LayoutItemNestedControlContainer runat="server">
                        <dx:ASPxButton ID="btnDanhSachDonHangChuaDuyet" runat="server" HorizontalAlign="Right" PostBackUrl="DanhSachDonHangChuaDuyet.aspx" Text="Danh sách đơn hàng chưa duyệt" VerticalAlign="Middle">
    ...
    <dx:ASPxPopupControl ID="popup" runat="server" AllowDragging="True" AllowResize="True" 
         ...
         Height="300px" FooterText="Thông tin chi tiết đơn đặt hàng"
