<%@ Page Title="" Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeBehind="DanhSachDonHangDaDuyet.aspx.cs" Inherits="BanHang.DanhSachDonHangDaDuyet" %>
            ...
            <dx:LayoutItem Caption="">
                <LayoutItemNestedControlCollection>
                    <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer2" runat="server">
                        <dx:ASPxButton ID="btnDanhSachDonHangChuaDuyet" runat="server" HorizontalAlign="Right" PostBackUrl="DuyetHangServer.aspx" Text="Danh sách đơn hàng chưa duyệt" VerticalAlign="Middle">
                            <Image IconID="spreadsheet_ungrouprows_32x32">
                            </Image>
