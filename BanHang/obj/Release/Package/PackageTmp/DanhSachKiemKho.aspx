...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    ...
    <dx:ASPxGridView ID="gridDanhSachKiemKho" runat="server" AutoGenerateColumns="False" Width="100%" KeyFieldName="ID">
        ...
        <Columns>
            ...
            <dx:GridViewDataComboBoxColumn Caption="Kho" FieldName="IDKho" VisibleIndex="1">
            ...
            <dx:GridViewDataComboBoxColumn Caption="Người Lập Phiếu" VisibleIndex="2" FieldName="IDNguoiDung">
                <PropertiesComboBox DataSourceID="sqlNguoiDung" TextField="TenNguoiDung" ValueField="ID">
                </PropertiesComboBox>
            </dx:GridViewDataComboBoxColumn>
            <dx:GridViewDataDateColumn Caption="Ngày Kiểm Kho" VisibleIndex="3" FieldName="NgayKiemKho">
