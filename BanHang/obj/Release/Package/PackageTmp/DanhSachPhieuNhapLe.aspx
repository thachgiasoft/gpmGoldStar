<%@ Page Title="" Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeBehind="DanhSachPhieuNhapLe.aspx.cs" Inherits="BanHang.DanhSachPhieuNhapLe" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
        
    <%--popup chi tiet don hang--%>
     <script type="text/javascript">
         function OnMoreInfoClick(element, key) {
             popup.SetContentUrl("ChiTietPhieuNhapLe.aspx?IDPhieuNhapLe=" + key);
             popup.ShowAtElement();
             // alert(key);
         }

    </script>
    <dx:ASPxButton ID="btnThemPhieuNhapLe" runat="server" Text="Thêm phiếu nhập lẻ" HorizontalAlign="Right" VerticalAlign="Middle" PostBackUrl="PhieuNhapLe.aspx">
        <Image IconID="reports_addgroupheader_32x32">
        </Image>
        <Paddings Padding="4px" />
    </dx:ASPxButton>
    <dx:ASPxGridView ID="gridPhieuNhapLe" runat="server" AutoGenerateColumns="False" Width="100%" KeyFieldName="ID" OnRowDeleting="gridPhieuNhapLe_RowDeleting">
        ...
        <SettingsText CommandDelete="Xóa" CommandEdit="Sửa" CommandNew="Thêm" Title="DANH SÁCH PHIẾU NHẬP LẺ" ConfirmDelete="Bạn chắc chắn muốn xóa?"/>
        <Columns>
    ...
    <%--popup chi tiet don hang--%>
     <dx:ASPxPopupControl ID="popup" runat="server" AllowDragging="True" AllowResize="True" 
        ...
        HeaderText="Thông tin chi tiết phiếu nhập lẻ" ClientInstanceName="popup" EnableHierarchyRecreation="True" CloseAction="CloseButton">
    </dx:ASPxPopupControl>
