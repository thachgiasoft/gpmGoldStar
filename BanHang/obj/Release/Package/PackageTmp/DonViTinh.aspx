    ...
    <dx:ASPxGridView ID="gridDonViTinh" runat="server" AutoGenerateColumns="False" KeyFieldName="ID" Width="100%" OnRowDeleting="gridDonViTinh_RowDeleting" OnRowInserting="gridDonViTinh_RowInserting" OnRowUpdating="gridDonViTinh_RowUpdating">
        ...
        <EditFormLayoutProperties>
            <Items>
                ...
                <dx:GridViewColumnLayoutItem ColumnName="Mô Tả" Name="MoTa" Visible="False">
                </dx:GridViewColumnLayoutItem>
                <dx:GridViewColumnLayoutItem ColumnName="Hệ Số" Name="HeSo" Visible="False">
                </dx:GridViewColumnLayoutItem>
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="Mô Tả" FieldName="MoTa" VisibleIndex="2" Visible="False">
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataSpinEditColumn Caption="Hệ Số" FieldName="HeSo" VisibleIndex="3" Visible="False">
