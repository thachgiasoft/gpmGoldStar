<%@ Page Title="" Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeBehind="DuyetHangClient.aspx.cs" Inherits="BanHang.DuyetHangClient" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    ...
    <dx:ASPxGridView ID="gridDanhSachDonHangChoDuyet" runat="server" AutoGenerateColumns="False" Width="100%" KeyFieldName="ID" OnRowDeleting="gridDanhSachDonHangChoDuyet_RowDeleting" OnCustomButtonCallback="gridDanhSachDonHangChoDuyet_CustomButtonCallback">
        ...
        <SettingsCommandButton>
         ...
         <SettingsText CommandDelete="Xóa" CommandEdit="Sửa" CommandNew="Thêm" ConfirmDelete="Bạn có chắc chắn muốn xóa không?" Title="DANH SÁCH ĐƠN HÀNG CHỜ DUYỆT" />
        <Columns>
            <dx:GridViewCommandColumn VisibleIndex="6" ButtonRenderMode="Image" ButtonType="Image">
                 <CustomButtons>
