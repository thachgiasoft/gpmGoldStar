<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">CÔNG VIÊN NƯỚC</li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{!! URL::route('goldstar-admin.cafe.qldanhmuc.danhsach') !!}"><i class="fa fa-circle-o"></i> Danh mục</a></li>
            <li><a href="pages/examples/invoice.html"><i class="fa fa-circle-o"></i> Saaaaa</a></li>
